...
| Job | 역할 |
|---|---|
| `rescaper-ci` | 구문 체크 + Playwright E2E 테스트 (27개) |
| `rescaper-deploy-prod` | Docker Hub 멀티 아키텍처 빌드 & Push |
| `rescaper-deploy-server` | 프로덕션 서버 Pull & 배포 |
